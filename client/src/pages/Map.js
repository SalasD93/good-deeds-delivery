...
export default function SetMap () {
  return (
    <div style={{ width: '100vw', height: '100vh'}}>
      <WrappedMap
        googleMapURL={`https://maps.googleapis.com/maps/api/js?v=3.exp&libraries=geometry,drawing,place&key=${
...
//   //   apiKey: 'AIzaSyBGjt8MdI_N4adowcL8ig1YcWWSkzGm3Tg0'
//   // })(MapContainer);
...
//     await async function getCoordinates(event) {
...
//     await function initMap(latitude, longitude) {
...
//     await async function setMarkers(map) {
//       console.log(user);
...
//                 const zipCode = user.zipCode;
//                 const response = fetch(`https://maps.googleapis.com/maps/api/geocode/json?address=${zipCode}&key=AIzaSyBGjt8MdI_N4adowcL8ig1YcWWSkzGm3Tg`).json();

//                 const userLat = response.results[0].geometry.location.lat;
//                 const userLng = response.results[0].geometry.location.lng;
...
//   //     zoom={10}
//   //     style={mapStyles}
//   //     initialCenter={{ lat: 27.88, lng: -82.8 }}
//   //   >
//   //     <Marker position ={{ lat: 27.88, lng: -82.8 }} />
//   //   </Map>
//   // );
// }
